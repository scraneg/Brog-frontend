  ...
  <div id="body">
    <div class="sub-main-w3">
      <form action="#" method="post">
        ...
        <div class="wrapper">
          <div class="forms-gds">
            <button class="btn" name="login" type="submit">登录</button>
            <button class="btn" name="register" type="submit" @click.prevent="$router.push('/register')">注册</button>
          </div>
        </div>
      </form>
    </div>
...
.sub-main-w3 form {
  ...
  border-radius: 30px 30px 30px 30px; /*我们都知道border-radius后面如果是4个值的话,依次代表的是左上角、右上角、右下角、左下角。就这样使边框有弯曲*/
}
